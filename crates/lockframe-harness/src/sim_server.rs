...
//!
//! `SimServer` wraps `ServerDriver` for integration with turmoil's
//! deterministic simulation. It uses `SimEnv` with `MemoryStorage` for the
//! action-based core, turmoil TCP for networking, and tracks connection state
//! in a `HashMap`.
